# PyInstaller spec for the manual-account paper-trading desktop window.
# Output: dist/StockCompDashboardManual/StockCompDashboard.exe
# Does not replace dist/StockCompDashboard/ or dist/StockCompDashboardAI/.
